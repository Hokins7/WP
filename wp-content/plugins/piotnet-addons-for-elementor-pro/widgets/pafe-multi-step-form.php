...
class PAFE_Multi_Step_Form extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		// 		'default' => 'dejaVu',
		// 		'options' => [
		// 			'dejaVu' => __('Unicoce', 'pafe'),
		// 			'Arial' => __('Arial', 'pafe'),
		// 			'Courier'  => __( 'Courier', 'pafe' ),
		// 			'Courier-Bold' => __( 'Courier-Bold', 'pafe' ),
		// 			'Courier-BoldOblique' => __( 'Courier-BoldOblique', 'pafe' ),
		// 			'Courier-Oblique' => __( 'Courier-Oblique', 'pafe' ),
		// 			'Helvetica' => __( 'Helvetica', 'pafe' ),
		// 			'Helvetica-Bold' => __( 'Helvetica-Bold', 'pafe' ),
		// 			'Helvetica-BoldOblique' => __( 'Helvetica-BoldOblique', 'pafe' ),
		// 			'Helvetica-Oblique' => __( 'Helvetica-Oblique', 'pafe' ),
		// 			'Symbol' => __( 'Symbol', 'pafe' ),
		// 			'Times-Roman' => __( 'Times-Roman', 'pafe' ),
		// 			'Times-Bold' => __( 'Times-Bold', 'pafe' ),
		// 			'Times-BoldItalic' => __( 'Times-BoldItalic', 'pafe' ),
		// 			'Times-Italic' => __( 'Times-Italic', 'pafe' ),
		// 			'ZapfDingbats' => __( 'ZapfDingbats', 'pafe' ),
		// 		],
		// 		'selectors' => [
		// 			'{{WRAPPER}} .pafe-form-builder-pdf-generator-preview__item' => 'color: {{VALUE}}',
		// 		],
		...
		// );
		// $this->add_control(
		// 	'pdfgenerator_font_weight',
		// 	[
		// 		'label' => __( 'Font Weight', 'pafe' ),
		// 		'type' => \Elementor\Controls_Manager::SELECT,
		// 		'default' => '',
		// 		'options' => [
		// 			''  => __( 'Normal', 'pafe' ),
		...
		$repeater->add_control(
			...
			[
				...
				'condition'=>[
					'pdfgenerator_field_type' => ['default', 'image-upload']
				]
			]
		);
				...
				<div class="pafe-multi-step-form__content">
					<?php foreach ($list as $item) : $index++; ?>
						<div class="pafe-multi-step-form__content-item<?php if($index == 1) : ?> active<?php endif; ?>">
							...
							<div class="pafe-multi-step-form__content-item-buttons">
								<?php if ($index != 1 && empty( $item['pafe_multi_step_form_item_disable_button_prev'] )) : ?>
									<div class="pafe-multi-step-form__content-item-button">
										<div <?php echo $this->get_render_attribute_string( 'button' ); ?> data-pafe-form-builder-nav="prev">
								...
								<?php if ($index != count($list) && empty( $item['pafe_multi_step_form_item_disable_button_next'] )) : ?>
									<div class="pafe-multi-step-form__content-item-button">
										<div <?php echo $this->get_render_attribute_string( 'button' ); ?> data-pafe-form-builder-nav="next">
											<span class="elementor-button-content-wrapper">
								...
								<?php if ($index == count($list) && empty( $item['pafe_multi_step_form_item_disable_button_next'] )) : ?>
									...
									<div class="pafe-multi-step-form__content-item-button">
										<div <?php echo $this->get_render_attribute_string( 'button' ); ?> <?php echo $this->get_render_attribute_string( 'button-submit' ); ?>>
											<span class="elementor-button-content-wrapper">
							...
							<div class="pafe-form-builder-pdf-generator-preview<?php if(empty($settings['pdfgenerator_set_custom'])) { echo ' pafe-form-builder-pdf-generator-preview--not-custom'; } ?>" style="width: 595px; height: 841px; border: 1px solid #000; margin: 0 auto; position: relative; <?php if(isset($pdf_generator_image)) {echo "background-image:url('".$pdf_generator_image."'); background-size: contain; background-position: left top; background-repeat: no-repeat;"; } ?>">
							...
							<?php endif; ?>
								<?php foreach($settings['pdfgenerator_field_mapping_list'] as $item): ?>
									...
									<div class="pafe-form-builder-pdf-generator-preview__item-image  elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?>" style="position: absolute; background-image:url(<?php echo plugins_url().'/piotnet-addons-for-elementor-pro/assets/images/signature.png'; ?>);line-height: 1; background-size: cover; background-repeat: no-repeat; text-align: center;width: 300px; height: 150px">
