...
define( 'PAFE_PRO_VERSION', '6.3.0' );
define( 'PAFE_PRO_PREVIOUS_STABLE_VERSION', '6.2.8' );
...
final class Piotnet_Addons_For_Elementor_Pro {
	...
	public function __construct() {
    	...
    	add_action('woocommerce_thankyou', [ $this, 'pafe_woocommerce_checkout_redirect'], 10, 1);
	...
	public function pafe_form_database_post_type() {
	    register_post_type('pafe-form-database',
			array(
				'labels'      => array(
					'name'          => __('PAFE Form Database'),
					'singular_name' => __('PAFE Form Database'),
				),
				'public'      => true,
				'has_archive' => true,
				'show_in_menu' => false,
	...
	public function init() {
		...
		$plugin_remote_path = 'https://pafe.piotnet.com/new-update/';
	...
	public function admin_menu() {
		...
		add_submenu_page('piotnet-addons-for-elementor', 'PAFE Form Database', 'PAFE Form Database', 'manage_options', 'edit.php?post_type=pafe-form-database');
	...
	public function init_widgets() {
		...
		if( get_option( 'pafe-advanced-search', 2 ) == 2 || get_option( 'pafe-advanced-search', 2 ) == 1 ) {
