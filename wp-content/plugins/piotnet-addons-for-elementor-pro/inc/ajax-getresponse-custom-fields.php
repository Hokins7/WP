    ...
    function pafe_getresponse_custom_fields(){
        ...
        if(!empty($result)){
            ...
            foreach($result as $item){
                $html .= '<div class="pafe-getresponse-custom-fields__inner"><label>'.$item->name.'</label><div class="pafe-getresponse-custom-fields__inner-item"><input type="text" value="'.$item->customFieldId.'" readonly/></div></div>';
            }
            echo $html;
        }
        wp_die();
